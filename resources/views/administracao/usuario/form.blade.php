    ...
    <div class="form-group row">
        <div class="col-sm-12 col-md-3">
            ...
            <input type="text" name="cpf" class="form-control {{$errors->has('cpf') ? 'is-invalid' : ''}}"
                aria-describedby="cpfFeedback" value="{{empty(old('cpf')) ? @$usuario->pessoaFisica->cpf : old('cpf')}}"
        ...
        <div class="col-sm-12 col-md-3">
            ...
            <select name="sexo" class="form-control select2 {{$errors->has('sexo') ? 'is-invalid' : ''}}"
                ...
                <option value="masculino"
                    {{(empty(old('sexo')) ? @$usuario->pessoaFisica->sexo : old('sexo')) == 'masculino' ? 'selected' : ''}}>
                    Masculino
                </option>

                <option value="feminino"
                    {{(empty(old('sexo')) ? @$usuario->pessoaFisica->sexo : old('sexo')) == 'feminino' ? 'selected' : ''}}>
                    Feminino
                </option>
            </select>
            @if ($errors->has('sexo'))
