...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('processos', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('tecnico_responsavel_id')->nullable();
            $table->unsignedBigInteger('situacao_acompanhamento_id')->nullable();
            ...
            $table->foreign('tecnico_responsavel_id')->references('id')->on('users');
            $table->foreign('situacao_acompanhamento_id')->references('id')
                ->on('situacoes_acompanhamentos');
